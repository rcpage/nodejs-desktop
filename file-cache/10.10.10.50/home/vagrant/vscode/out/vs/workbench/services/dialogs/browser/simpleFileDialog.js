...
define(["require", "exports", "vs/nls", "vs/base/common/resources", "vs/base/common/objects", "vs/platform/files/common/files", "vs/platform/quickinput/common/quickInput", "vs/base/common/uri", "vs/base/common/platform", "vs/platform/dialogs/common/dialogs", "vs/platform/remote/common/remoteHosts", "vs/platform/label/common/label", "vs/platform/workspace/common/workspace", "vs/platform/notification/common/notification", "vs/editor/common/services/modelService", "vs/editor/common/services/modeService", "vs/editor/common/services/getIconClasses", "vs/base/common/network", "vs/workbench/services/environment/common/environmentService", "vs/workbench/services/remote/common/remoteAgentService", "vs/platform/contextkey/common/contextkey", "vs/base/common/strings", "vs/platform/keybinding/common/keybinding", "vs/base/common/extpath", "vs/workbench/browser/contextkeys", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/common/async", "vs/workbench/services/editor/common/editorService", "vs/base/common/labels"], function (require, exports, nls, resources, objects, files_1, quickInput_1, uri_1, platform_1, dialogs_1, remoteHosts_1, label_1, workspace_1, notification_1, modelService_1, modeService_1, getIconClasses_1, network_1, environmentService_1, remoteAgentService_1, contextkey_1, strings_1, keybinding_1, extpath_1, contextkeys_1, event_1, lifecycle_1, async_1, editorService_1, labels_1) {
    ...
    (function (SaveLocalFileCommand) {
        ...
        function handler() {
            return accessor => {
                ...
                if (activeControl) {
                    return editorService.save({ groupId: activeControl.group.id, editor: activeControl.input }, { saveAs: true, availableFileSystems: [network_1.Schemas.file], reason: 1 /* EXPLICIT */ });
                }
    ...
    let SimpleFileDialog = class SimpleFileDialog {
        ...
        async createItem(filename, parent, token) {
            if (token.isCancellationRequested) {
                return undefined;
            }
