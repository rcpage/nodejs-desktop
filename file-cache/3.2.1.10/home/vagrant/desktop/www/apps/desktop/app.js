...
app.controller('DesktopController', function($scope) {
  ...
  $scope.Tasks = [
    (new TaskMenu(1, 'File Navigator')).addWindow(1,'File Navigator', 'http://rusty.com/angular/controller/file-system.html'),
    (new TaskMenu(2, 'Text Editor')).addWindow(2,'Test Editor', 'http://rusty.com/angular/controller/text-editor.html?id=5c2d3cc8b8b96f59fcc331dd&source=/home/vagrant/stack/www/angular/controller/desktop/index.html&mode=htmlmixed'),
